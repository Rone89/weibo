...
enum L10n {
    ...
    static let actionPanelSubtitle = "\u{8fdc}\u{7a0b}\u{65ad}\u{70b9}\u{6062}\u{590d}\u{540e}\u{ff0c}\u{53ef}\u{4ee5}\u{4ece}\u{5934}\u{5f00}\u{59cb}\u{91cd}\u{65b0}\u{64ad}\u{653e}"
